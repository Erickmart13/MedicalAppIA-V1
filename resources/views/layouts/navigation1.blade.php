                ...
                <nav>
                    ...
                    <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                        ...
                        <li class="text-sm pl-2 capitalize leading-normal text-white before:float-left before:pr-2 before:text-white before:content-['/']"
                            aria-current="page">@yield('page-title','Bienvenidos')</li>
                    </ol>
                    <h4 class="mb-0 font-normal text-white capitalize">Sistema Hospitalario Isidro Ayora</h4>
                </nav>
                        ...
                        <li class="relative flex items-center pr-2">
                          ...
                          <ul dropdown-menu
                              ...
                              <li class="relative mb-2">
                                  <a href="{{ route('profile.edit') }}" class="dark:hover:bg-slate-900 ease py-1.2 clear-both block w-full whitespace-nowrap rounded-lg bg-transparent px-4 duration-300 hover:bg-gray-200 hover:text-slate-700 lg:transition-colors"
                                      href="javascript:;">
                                      <div class="flex py-1">
                                          <div class="my-auto">
                                              <i 
                                                  class="fas fa-user inline-flex items-center justify-center mr-4 text-sm h-9 w-9 max-w-none rounded-xl" ></i>
                                                  
                                                </div>
                                          <div class="flex flex-col justify-center">
                                              <h6 class="mb-1 text-sm font-normal leading-normal dark:text-white">
                                                  <span class="font-semibold">Mi perfil</span></h6>
