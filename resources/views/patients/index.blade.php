                                        ...
                                        <td
                                            ...
                                            <form action="{{ url('/patients/' . $patient->id) }}" method="POST">
                                                ...
                                                <a class="inline-block dark:text-white px-2 py-2.5 mb-0 font-bold text-center align-middle transition-all bg-transparent border-0 rounded-lg shadow-none cursor-pointer leading-normal text-mb ease-in bg-150 hover:-translate-y-px active:opacity-85 bg-x-25 text-slate-700"
                                                    href="{{ url('/patients/' . $patient->id) }}">
                                                    <i class="mr-2 far fa-eye text-blue-500" aria-hidden="true"></i>
                                                </a>
                                                
                                                <a class="inline-block dark:text-white px-2 py-2.5 mb-0 font-bold text-center align-middle transition-all bg-transparent border-0 rounded-lg shadow-none cursor-pointer leading-normal text-mb ease-in bg-150 hover:-translate-y-px active:opacity-85 bg-x-25 text-slate-700"
                                                    href="{{ url('/patients/' . $patient->id . '/edit') }}">
                                                    <i class="mr-2 fas fa-pencil-alt text-lime-500" aria-hidden="true"></i>
                                                </a>
                                                ...
                                                <button type="submit"
                                                    ...
                                                    <i class="mr-2 far fa-trash-alt bg-150 bg-gradient-to-tl from-red-600 to-orange-600 bg-x-25 bg-clip-text"></i>
                                                </button>
                                            </form>
