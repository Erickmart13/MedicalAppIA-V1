        ...
        <div class="flex-none w-full max-w-full px-3">
            <div
                ...
                <div class="flex items-center p-4 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                    <h6 class="dark:text-white">Ver médico</h6>
                    <a href=" {{ url('/doctors') }}"
                ...
                <form action="{{ url('/doctors/' . $doctor->id) }}" method="POST"
                    ...
                    <div class="flex flex-wrap -mx-3">
                        ...
                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                            <div class="mb-4">
                                ...
                                <input disabled id="cedula" placeholder="Ingrese el número de cédula del médico" type="text"
                        ...
                        <div class="w-full max-w-full px-3 shrink-0 md:w-3/12 md:flex-0">
                            <div class="mb-4">
                                <label class="block text-gray-700 text-sm font-bold mb-2" for="date_of_birth">Fecha de
                                    nacimiento</label>
                                <input disabled value="{{ old('date_of_birth', $doctor->person) }}" placeholder="Ingrese la fecha"
                    ...
                    <div class="w-full max-w-full px-3">
                        <div class="mb-4">
                            ...
                            <select disabled id="specialties" name="specialties[]"
                    ...
                    <div class="flex flex-wrap -mx-3">
                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                            <div class="mb-4">
                                <label class="block text-gray-700 text-sm font-bold mb-2" for="email">Correo
                                    electrónico</label>
                                <input disabled id="email" placeholder="Ingrese el correo electrónico del médico" type="text"
                        ...
                        <div class="w-full max-w-full px-3 shrink-0 md:w-8/12 md:flex-0">
                            <div class="mb-4">
                                ...
                                <input disabled id="address" placeholder="Ingrese la dirección del médico" type="text"
                        ...
                        <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                            <div class="mb-4">
                                <label class="block text-gray-700 text-sm font-bold mb-2" for="city_id">Ciudad de
                                    residencia</label>
                                <select disabled name="city_id" required
                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
