        ...
        <div class="flex-none w-full max-w-full px-3">
            <div
                ...
                <div class=" flex items-center p-4 px-3 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                    <h6 class="dark:text-white mb-0">Nuevo consultorio</h6>
                    <a href=" {{ url('/offices') }}"
                    ...
                    <div class="flex flex-wrap -mx-3">
                        ...
                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                            <div class="mb-4">
                                ...
                                <textarea
                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none""
                                    id="description" name="description" placeholder="Ingrese la descripción del consultorio">{{ Request::old('description') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                            <div class="mb-4">
                                ...
                                <textarea
                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none""
                                    id="location" name="location" placeholder="Ingrese la ubicación del consultorio">{{ Request::old('location') }}</textarea>
                            </div>
