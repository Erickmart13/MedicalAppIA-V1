        ...
        <tbody>
            @foreach ($confirmedAppointments as $appointment)
                <tr>
                    ...
                    <td
                        class=" text-sm leading-normal text-center align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                        <div class="flex px-2 py-1">
                            ...
                            <div class="flex flex-col justify-center">
                                ...
                                @else
                                    ...
                                    @else
                                        <span
                                            class="bg-gradient-to-tl from-blue-500 to-sky-500 px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">
                                            Confirmada
                                        </span>
                                    @endif
                                @endif
