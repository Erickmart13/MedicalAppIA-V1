    ...
    <div class="flex flex-wrap -mx-3">
        <div class="flex-none w-full max-w-full px-3">
            ...
            <div>
                ...
                <form action="{{ url('/emergencies/'.$emergency->id) }}" method="POST"
                    ...
                    <div class="flex flex-wrap -mx-3  ">
                        <div class="w-full max-w-full px-3 shrink-0 md:w-2/12 md:flex-0">
                            ...
                            <input
                                class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none"
                                @error('heart_rate') border-red-500 @enderror" id="heart_rate" name="heart_rate"
                                type="number" min="60" max="100" placeholder="" required
                                
                                value="{{ old('heart_rate', $emergency) }}">
                        </div>
                        <div class="w-full max-w-full px-3 shrink-0 md:w-2/12 md:flex-0">
                            ...
                            <input
                                class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none"
                                @error('respiratory_rate') border-red-500 @enderror" id="respiratory_rate"
                                name="respiratory_rate" type="number" min="12" max="20" placeholder="" required
                                value="{{ old('respiratory_rate',$emergency) }}">
                        </div>
                        ...
                        <div class="w-full max-w-full px-3 shrink-0 md:w-2/12 md:flex-0">
                            ...
                            <input
                                class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none"
                                @error('blood_pressure') border-red-500 @enderror" id="blood_pressure" name="blood_pressure"
                                type="text" placeholder="" required value="{{ old('blood_pressure',$emergency) }}">
                        </div>
                        <div class="w-full max-w-full px-3 shrink-0 md:w-2/12 md:flex-0">
                            ...
                            <input
                                class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none"
                                @error('temperature') border-red-500 @enderror" id="temperature" name="temperature"
                                type="number" placeholder="" step="0.01" required value="{{ old('temperature',$emergency) }}">
                        </div>
                        <div class="w-full max-w-full px-3 shrink-0 md:w-3/12 md:flex-0">
                            ...
                            <input
                                class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none"
                                @error('oxygen_saturation') border-red-500 @enderror" id="oxygen_saturation"
                                name="oxygen_saturation" type="number" placeholder="" step="0.01" required
                                value="{{ old('oxygen_saturation',$emergency) }}">
                        </div>
                                ...
                                <div class="flex space-x-4">
                                    ...
                                    <div class="flex items-center px-4">
                                        <input id="severity_alto" type="radio" name="severity" value="alto"
                                            ...
                                            @if (old('severity',$emergency) == 'alto') checked @endif>
                                        <label for="severity_alto"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Alto</label>
                                    </div>
                                    ...
                                    <div class="flex items-center px-4">
                                        <input id="severity_medio" type="radio" name="severity" value="medio"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                            @if (old('severity',$emergency) == 'medio') checked @endif>
                                        <label for="severity_medio"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Medio</label>
                                    </div>
                                    ...
                                    <div class="flex items-center px-4">
                                        <input id="severity_bajo" type="radio" name="severity" value="bajo"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                            @if (old('severity',$emergency) == 'bajo') checked @endif>
                                        <label for="severity_bajo"
                                            class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Bajo</label>
                                    </div>
                                </div>
                    ...
                    <div class="flex justify-end ">
                        <button type="submit"
                            class="inline-block px-4 py-2  ml-auto font-bold leading-normal text-center text-white align-middle transition-all ease-in bg-lime-500 border-0 rounded-lg shadow-md cursor-pointer text-md tracking-tight-rem hover:shadow-xs hover:-translate-y-px active:opacity-85">Registrar
                            Triaje
                    </div>
                </form>
            </div>
